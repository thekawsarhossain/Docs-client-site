const RBlog = () => {
  return (
    <div className="col-span-12 mx-2  md:col-span-6">
      <div className=" rounded-lg bg-slate-300 p-3 dark:bg-Docy-Dark">
        <div className="block items-center divide-gray-100 sm:flex md:divide-x">
          <form className="mb-4 sm:mb-0 sm:pr-3" action="#" method="GET">
            ...
            <div className="relative mt-1 sm:w-64 xl:w-96">
              <input
                ...
                name="email"
                id="products-search"
                className="mb-4 block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-gray-900 focus:border-cyan-600 focus:ring-cyan-600 dark:bg-Docy-Dark sm:text-sm"
          ...
          <div className="flex w-full items-center sm:justify-end">
            <div className="hidden space-x-1 pl-2 md:flex">
              <a
                href="#"
                className="darkhover:bg-gray-100: inline-flex cursor-pointer justify-center rounded p-1 text-gray-500 hover:bg-Docy-DarkLight hover:text-gray-900"
              >
                <svg
                  className="h-6 w-6"
                  fill="currentColor"
                ...
                <table className="min-w-full table-fixed divide-y divide-gray-200">
                  <thead className="bg-gray-100 dark:bg-Docy-Dark">
                    <tr>
                      ...
                      <th
                        scope="col"
                        className="p-4 text-left text-xs font-medium uppercase text-gray-500 dark:text-slate-200"
                      >
                        Product Name
                      </th>
                      <th
                  ...
                  <tbody className="divide-y divide-gray-200 bg-white dark:bg-Docy-Dark">
                    ...
                    <tr className="hover:bg-gray-100 dark:hover:bg-Docy-AlmostBlack">
                      ...
                      <td className="whitespace-nowrap p-4 text-sm font-normal text-gray-500">
                        ...
                        <div className="text-sm font-normal text-gray-500 dark:text-slate-200">
                          category
                        </div>
                      </td>
                      <td className="whitespace-nowrap p-4 text-base font-medium text-gray-900 dark:text-slate-200">
                        technology
                      </td>
                      <td className="whitespace-nowrap p-4 text-base font-medium text-gray-900 dark:text-slate-200">
                        #id
        ...
        <div className=" bottom-0 right-0 w-full items-center border-t border-gray-200 bg-white p-4 dark:bg-Docy-Dark sm:flex sm:justify-between">
          <div className="mb-4 flex items-center sm:mb-0">
            <a
              href="#"
              className="inline-flex cursor-pointer justify-center rounded p-1 text-gray-500 hover:bg-gray-100 hover:text-gray-900 dark:text-slate-200 dark:hover:bg-Docy-DarkGray dark:hover:text-slate-200"
            >
              <svg
                className="h-7 w-7"
                fill="currentColor"
            ...
            <a
              href="#"
              className="mr-2 inline-flex cursor-pointer justify-center rounded p-1 text-gray-500 hover:bg-gray-100 hover:text-gray-900 dark:text-slate-200 dark:hover:bg-Docy-DarkGray dark:hover:text-slate-200"
            >
              <svg
                className="h-7 w-7"
                fill="currentColor"
