      ...
      <Box sx={{ flexGrow: 1 }}>
        <Grid className="m-2" container spacing={2}>
                    ...
                    <li className=" mb-6 px-4">
                      <div className="info flex items-center">
                        <img
                          ...
                          className="h-16 w-16  rounded-full border-4 border-indigo-600"
                          alt=""
                        />
                        <h6 className="ml-3 font-bold">Rakibul Hasan</h6>
                      </div>
                    </li>
                    <li className=" mb-6 px-4">
                      <div className="info flex items-center">
          ...
          <Grid item xs={12} md={8}>
            <Container>
              <div className="">
                <h2 className="title ml-28 mt-6 mb-10 md:ml-96">My Posts</h2>
                <div>
                  <Grid
                    className="mb-8"
                    container
                  ...
                  >
                    <Grid item xs={12} sm={6} md={4}>
                      <img
                        src="https://images.unsplash.com/photo-1604700403855-dc64a1320324?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1469&q=80"
                    ...
                    <Grid item xs={12} sm={6} md={8}>
                      <Link href="/">
                        <a>
                          <div className=" h-72 border  px-6  py-5 hover:shadow md:h-64 md:rounded">
