...
const Footer = () => {
  return (
    <footer className=" bg-slate-100 pt-10 text-white dark:bg-black dark:text-black  lg:pt-32">
        <ScrollToTop smooth top="500" color="#ffffff"  viewBox="0 0 330 330"
        ...
        C261.465,190.251,261.465,199.749,255.606,205.606z"  style={{borderRadius:'20px',paddingLeft:'6px',backgroundColor:'#4f46e5'}} />
      {/* <FooterBanner /> */}
      <Container>
