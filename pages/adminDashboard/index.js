...
import GrapCharts from '../../components/Chart/Chart'
...
export default function Index() {
  ...
  return (
    <DashboardLayout>
      <div className="bg-slate-200 p-5 dark:bg-Docy-AlmostBlack">
        <div className="grid grid-cols-1 gap-8 p-4 lg:grid-cols-2 xl:grid-cols-4">
          ...
          <div className="dark:bg-darker flex h-28 items-center justify-between rounded-md bg-white p-4 text-black dark:bg-Docy-Dark dark:text-white">
            <div>
              <h6 className="dark:text-primary-light text-xs font-medium uppercase leading-none tracking-wider text-gray-500 dark:text-gray-300">
                Video
              </h6>
              <span className="text-xl font-semibold">{videos?.length}</span>
          ...
          <div className="dark:bg-darker flex h-28 items-center justify-between rounded-md bg-white p-4 text-black dark:bg-Docy-Dark dark:text-white">
            <div>
              ...
              <span className="text-xl font-semibold">{emails?.length}</span>
              <span className="ml-2 inline-block rounded-md bg-green-100 px-2 py-px text-xs text-green-500">
                +3.1%
              </span>
            </div>
        ...
        <div className="grid grid-cols-12 gap-5">
                ...
                <div className="mb-0 rounded-t bg-transparent px-4 py-3">
                  <div className="flex flex-wrap items-center">
                    <div className="relative w-full max-w-full flex-1 flex-grow">
                      <h6 className="text-blueGray-100 mb-1 text-xs font-semibold uppercase text-black dark:text-white">
                        Overview
                      </h6>
          ...
          <div className="col-span-12 sm:col-span-4">
            <div className="relative mb-6 flex h-full w-full min-w-0 flex-col break-words rounded-xl bg-gray-50 shadow-lg dark:bg-Docy-Dark">
              <PieCharts />
            </div>
          </div>
        </div>
